...
[CreateAssetMenu]
public class WaveEnemyDataArrayEntity :ScriptableObject
{
    public WaveEnemyData[] array;
    ...
    public void LoadSheetData()
    {
        ...
        array = CSVSerializer.Deserialize<WaveEnemyData>(request.downloadHandler.text);
...
[CustomEditor(typeof(WaveEnemyDataArrayEntity))]
public class WaveEnemyDataListEntityEditor :Editor
{
    public override void OnInspectorGUI()
    {
        ...
        {
            ((WaveEnemyDataArrayEntity)target).LoadSheetData();
        }
    }
}
#endif