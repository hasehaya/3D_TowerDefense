...
[CreateAssetMenu]
public class FacilityAttackParameterListEntity :ScriptableObject
{
    public FacilityAttackParameter[] lists;
    ...
    public void LoadSheetData()
    {
        ...
        lists = CSVSerializer.Deserialize<FacilityAttackParameter>(request.downloadHandler.text);
...
[CustomEditor(typeof(FacilityAttackParameterListEntity))]
public class FacilityAttackParameterListEntityEditor :Editor
{
    public override void OnInspectorGUI()
    {
        ...
        {
            ((FacilityAttackParameterListEntity)target).LoadSheetData();
        }
    }
}
#endif
