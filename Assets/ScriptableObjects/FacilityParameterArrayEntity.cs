...
[CreateAssetMenu]
public class FacilityParameterArrayEntity :ScriptableObject
{
    public FacilityParameter[] array;
    ...
    public void LoadSheetData()
    {
        ...
        array = CSVSerializer.Deserialize<FacilityParameter>(request.downloadHandler.text);
...
[CustomEditor(typeof(FacilityParameterArrayEntity))]
public class FacilityParameterListEntityEditor :Editor
{
    public override void OnInspectorGUI()
    {
        ...
        {
            ((FacilityParameterArrayEntity)target).LoadSheetData();
        }
    }
}
#endif
